				...
				<div class="card-body">
					<form class="needs-validation" novalidate="" method="POST" action="{{route('biodata.store')}}">
						...
						<div class="row g-3">
							...
							<div class="col-md-6">
								<label class="form-label" for="validationCustom02">Star Year</label>
								<input class="form-control" id="validationCustom02" type="text" name="star_year" required="" />
								<div class="valid-feedback">Looks good!</div>
							</div>
						</div>
						<br>
						<div class="row g-3">
							<div class="col-md-6">
								...
								<input class="form-control" id="validationCustom01" type="text" name="end_year" value="" required="" />
								<div class="valid-feedback">Looks good!</div>
							</div>
							<div class="col-md-6">
						...
						<div class="row g-3">
							<div class="col-md-6">
								...
								<input class="form-control" id="validationCustom01" type="text" name="start_date" value="" required="" />
								<div class="valid-feedback">Looks good!</div>
							</div>
							<div class="col-md-6">
								<label class="form-label" for="validationCustom02">End Date</label>
								<input class="form-control" id="validationCustom02" type="text" name="end_date" required="" />
								<div class="valid-feedback">Looks good!</div>
							</div>
						</div>
						<br>
						<div class="row g-3">
							<div class="col-md-6">
								...
								<input class="form-control" id="validationCustom01" type="text" name="street_adres" value="" required="" />
								<div class="valid-feedback">Looks good!</div>
							</div>
							<div class="col-md-6">
